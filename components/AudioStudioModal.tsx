    ...
    const handlePlayPause = async () => {
        if (isPlaying) {
            ...
            if (ctx) {
                ...
                if (playbackOffsetRef.current > fileDuration) playbackOffsetRef.current = 0; // Reset if finished
            }
            stopPlayback();
            return;
        }
        ...
        try {
            ...
            const processedVoice = await processAudio(voiceBuffer, settings, null, 0); 
